...
#     raw = run_network(pts)
    ...
    latitude_step = 18   # 緯度方向のステップ（度）

    # 経度と緯度の範囲
    longitudes = np.arange(0, 360 + longitude_step, longitude_step)  # 0度から360度（360度は含まない）
    latitudes = np.arange(-90, 90 + latitude_step, latitude_step)  # -90度から90度
